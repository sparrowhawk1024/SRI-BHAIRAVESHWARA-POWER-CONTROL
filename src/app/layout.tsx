...
export const metadata: Metadata = {
  ...
  description:
    "Leading manufacturer of MCC, PCC, AMF, APFC, E-House, Synchronizing and LT control panels in Bangalore. Design, manufacture and commissioning of premium industrial electrical control solutions since 2008.",
  keywords:
